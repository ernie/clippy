...
class Clippy {
  ...
  static function main() {
    ...
    var parameter:String = flash.Lib.current.loaderInfo.parameters.parameter;
    ...
    button.addEventListener(MouseEvent.MOUSE_UP, function(e:MouseEvent) {
      var text:String;
      if (parameter != null) {
        text = ExternalInterface.call(callBack, parameter);
      } else {
        text = ExternalInterface.call(callBack);
      }
